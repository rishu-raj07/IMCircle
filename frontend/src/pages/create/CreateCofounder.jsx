    ...
    try {
      ...
      alert(
        error?.response?.data?.message ||
          "Failed to create co-founder opportunity. Please try again."
      );
    } finally {
      setLoading(false);
    }
      ...
      <main className="px-4 pt-5">
        <div className="mb-6">
          ...
          <p className="mt-2 text-[14px] font-semibold leading-relaxed text-[var(--imc-text-muted)]">
            Share what you are building and what kind of co-founder you need.
          </p>
        </div>
        ...
        <section className="space-y-4 rounded-[28px] border border-[var(--imc-border)] bg-[var(--imc-surface)] p-4 shadow-[0_8px_24px_rgba(15,23,42,0.035)]">
          ...
          <div>
            <Label title="Monthly pay / equity note optional" />
          ...
          <div>
            ...
            <div className="mt-2 flex h-12 items-center gap-2 rounded-2xl bg-[var(--imc-surface-2)] px-4">
              ...
              <input
                ...
                placeholder="Tech, Sales, Marketing..."
          ...
          <div>
            <Label title="What are you building?" />

            <textarea
              value={form.description}
              onChange={(e) => updateForm("description", e.target.value)}
              placeholder="Explain your startup, stage, traction, vision, expected role, equity/pay and why someone should join you..."
              className="mt-2 min-h-[190px] w-full resize-none rounded-[24px] bg-[var(--imc-surface-2)] p-4 text-[14px] font-semibold leading-6 text-[var(--imc-text)] outline-none placeholder:text-[var(--imc-text-faint)]"
            />
          </div>
        </section>
        ...
        >
          <Send size={18} />
          {loading ? "Posting..." : "Post Co-founder Need"}
        </button>
      </main>
...
export default CreateCofounder;